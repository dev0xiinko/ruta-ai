  ...
  return (
    <footer className="border-t border-border bg-background py-8 sm:py-12 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pt-4 sm:pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-[11px] sm:text-xs text-muted-foreground text-center sm:text-left">
